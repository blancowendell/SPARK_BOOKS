...
import PrivateReports from './parts/PrivateReports';
import Recent from './parts/Recent';
import MyReports from './parts/MyReports';
import CuratedReports from './parts/CuratedReports';
import SharedReports from './parts/SharedReports';

const ReportsPage = () => {
    const [collapsed, setCollapsed] = useState(false);
    const [activePage, setActivePage] = useState('My reports');
    ...
    const renderMainContent = () => {
        switch (activePage) {
            ...
            case 'Recent':
                return <Recent />;
            case 'Curated reports':
                return <CuratedReports />;
            case 'Shared reports':
        ...
        <div className="flex h-screen bg-white shadow rounded-2xl p-3">
            ...
            >
                <div className="flex items-center justify-between mb-6">
                    {!collapsed && <span className="text-2xl font-bold">Analytics</span>}
                </div>
                ...
                <nav className="flex-1 space-y-2">
                    ...
                    <NavItem
                        ...
                        collapsed={collapsed}
                        onClick={setActivePage}
                        active={activePage === 'Curated reports'}
                    />
                    <NavItem
                        ...
                        collapsed={collapsed}
                        onClick={setActivePage}
                        active={activePage === 'Private reports'}
                    />
                    <NavItem
